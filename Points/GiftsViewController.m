...
- (void)viewDidLoad {
    ...
    _gifts = [Database sharedDatabase].allGifts;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    GiftsViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier forIndexPath:indexPath];
    
    GiftInfo *info = self.gifts[indexPath.row];
